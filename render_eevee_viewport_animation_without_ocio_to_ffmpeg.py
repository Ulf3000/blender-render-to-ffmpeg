...
origLook = bpy.context.scene.view_settings.look
origFileFormat = bpy.context.scene.render.image_settings.file_format



finalRenderPath = bpy.context.scene.render.filepath + ".mov"
...
# eevee is not good at applying lut(ocio), banding and wrong colors are the result but for preview its better than nothing
...
# set to png or openEXR  !!! important set up the values beforehand i.e. png with rgba 16bit or exr with halffloat and alpha
...
#subprocess.run(['cmd',cmdParameters])
